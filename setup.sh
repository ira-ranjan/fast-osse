...
OUTPUT_DIR="/glade/derecho/scratch/iranjan/archive/EEP_MITgcm185Lvgrid_Whitt2026hgrid/ocn/hist/split"
...
python ${PYTHON_SCRIPT} "${FILE}" "${OUTPUT_DIR}" "${STATIC_FILE}" "${OCEAN_GEOM_FILE}" "${PMO_EXEC}"
